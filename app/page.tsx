...
import { prayerTimeV3 } from "@/server/prayerTime";
// interface Prayer {
//   data:{
//     timings: {
//       Fajr: number,
        ...
        <Suspense fallback={<Loading />}>
          ...
          <div className="divide-y divide-slate-200 my-2 mb-10">
            ...
            <div className="flex justify-between align-middle py-3">
              ...
              <h3 className="text-lg font-medium">{prayer.items[0].shurooq}</h3>
            </div>
            <div className="flex justify-between align-middle py-3">
            ...
            <div className="flex justify-between align-middle py-3">
              ...
              <h3 className="text-lg font-medium">{prayer.items[0].maghrib}</h3>
            </div>
            <div className="flex justify-between align-middle py-3">
